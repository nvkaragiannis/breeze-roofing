...
export const services: Service[] = [
  {
    ...
    icon: "Home",
    image: { src: "/residential_roofing_pic.jpeg", alt: "Aerial view of residential roof installation in Wilmington NC with crew working" },
...
- **IBHS Fortified-Rated Systems** — Full Fortified Roof designation for insurance savings`,
  ...
  },
  {
    ...
    icon: "Building2",
    image: { src: "/commericla_roofing_pic.webp", alt: "Aerial view of commercial flat roof system on large building" },
...
Regular maintenance extends your commercial roof's lifespan by years. We offer scheduled inspection programs that catch small issues before they become expensive problems.`,
  ...
  },
  {
    ...
    icon: "RefreshCcw",
    image: { src: "/roof_replacement_pic.jpg", alt: "Roofing crew installing underlayment during a roof replacement" },
...
- **Vent and Pipe Boot Replacement** — Common leak source on aging roofs`,
  ...
  },
  {
    ...
    icon: "Clock",
    image: { src: "/emergency_repairs_pic.jpeg", alt: "Emergency blue tarps covering damaged roof sections after storm" },
    showEmergency: true,
...
- Ceiling collapse or buckling`,
  ...
  },
  {
    ...
    icon: "CloudLightning",
    image: { src: "/storm_damage_repair_pic.webp", alt: "Storm-damaged roof with missing shingles and exposed decking" },
    showEmergency: true,
...
- **Water Intrusion** — Leak repair and water damage from compromised roofing`,
  ...
  },
  {
    ...
    icon: "Search",
    image: { src: "/roof_inspections_pic.webp", alt: "Roof inspector on ladder with clipboard examining metal roof" },
...
- Before your insurance renewal (especially if considering Fortified upgrade)`,
  ...
  },
  {
    ...
    icon: "HardHat",
    image: { src: "/new_construction_pic.webp", alt: "Roofer installing shingles on new construction home" },
...
- **Warranty Support** — We stand behind our work with manufacturer warranty registration`,
  ...
  },
  {
    ...
    icon: "Award",
    image: { src: "/solar_ready_roofing_pic.webp", alt: "Professional roofing crew working on residential roof installation" },
    featured: true,
...
A Fortified Roof costs somewhat more than a standard installation — typically 10-20% more. But when you factor in the insurance savings over 10-20 years, most homeowners find it pays for itself. And you get a better roof.`,
  ...
  },
  {
    ...
    icon: "Settings",
    image: { src: "/maintenance_programs.webp", alt: "Roofing professional with safety harness inspecting shingle roof" },
