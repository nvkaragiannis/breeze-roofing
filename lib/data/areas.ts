...
export const areas: ServiceArea[] = [
  {
    ...
    metaDescription: "Breeze Roofing serves Wilmington, NC with residential and commercial roofing, storm damage repair, and IBHS Fortified Roof installation. Free estimates. ${company.phoneFormatted}",
  ...
  },
  {
    ...
    metaDescription: "Breeze Roofing serves Hampstead, NC with residential roofing, storm damage repair, and IBHS Fortified Roof installation. Free estimates. ${company.phoneFormatted}",
  ...
  },
  {
    ...
    metaDescription: "Breeze Roofing serves Leland, NC with residential roofing, storm damage repair, and IBHS Fortified Roof installation. Free estimates. ${company.phoneFormatted}",
  ...
  },
  {
    ...
    metaDescription: "Breeze Roofing serves Carolina Beach, NC with coastal-rated roofing, storm damage repair, and Fortified Roof installation. Free estimates. ${company.phoneFormatted}",
  ...
  },
  {
    ...
    metaDescription: "Breeze Roofing serves Wrightsville Beach, NC with premium coastal roofing, storm damage repair, and Fortified Roof installation. Free estimates. ${company.phoneFormatted}",
  ...
  },
  {
    ...
    metaDescription: "Breeze Roofing serves Southport, NC with residential roofing, storm damage repair, and Fortified Roof installation. Free estimates. ${company.phoneFormatted}",
  ...
  },
  {
    ...
    metaDescription: "Breeze Roofing serves Topsail Island, NC with island-grade roofing, storm damage repair, and Fortified Roof installation. Free estimates. ${company.phoneFormatted}",
  ...
  },
  {
    ...
    metaDescription: "Breeze Roofing serves Surf City, NC with coastal roofing, storm damage repair, and Fortified Roof installation. Free estimates. ${company.phoneFormatted}",
